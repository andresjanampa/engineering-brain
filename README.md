...
This repository contains the project-aware MVP foundation. The `brain scan` workflow scans a repository locally and writes a structured snapshot containing:
